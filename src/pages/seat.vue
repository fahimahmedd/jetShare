            ...
            <v-col cols="4">
                <div class="subpage-left" style="background-image: url('/public/images/subPage/seat.svg')">
                    ...
                    <h3 class="text-grey-lighten-2 font-weight-regular">
                        Lets fly to <strong class="text-white">Stockholm</strong>
                    </h3>
                </div>
            </v-col>
            <v-col cols="8">
                <div class="subpage-content">
                    <SubHeader />
                    <v-container>
                      <h2 class="text-black font-weight-regular text-h3 mt-10">Seating</h2>
                      <div class="placeholder-text text-grey-lighten-1 font-weight-medium text-h3 mt-10">Choose Your Seat</div>
